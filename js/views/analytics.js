        ...
        container.innerHTML = `
            <div class="analytics-container animate-fade-in">
                <div style="margin-bottom: 2rem;">
                    <h2 style="font-weight: 800; color: var(--text-main);">Analytics & Insights</h2>
                ...
                <div class="grid-3" style="margin-bottom: 2rem;">
                    <div class="card stat-card">
                        ...
                        <div>
                            ...
                            <p class="stat-value">${studyTimeData.length > 0 ? Math.round(studyTimeData.reduce((a, b) => a + b, 0) / 60) : 0} <span style="font-size: 1rem; color: var(--text-muted); font-weight: 400;">hours</span></p>
                        </div>
                    </div>
                    <div class="card stat-card">
                        <div style="font-size: 2rem;">🔥</div>
                    ...
                    <div class="card stat-card">
                        ...
                        <div>
                            ...
                            <p class="stat-value">${Math.floor(totalStudyTime / 60)} <span style="font-size: 1rem; color: var(--text-muted); font-weight: 400;">hours</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid-2" style="margin-bottom: 2rem;">
                    <div class="card chart-card">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                            ...
                            <span style="font-size: 0.85rem; color: var(--text-muted);">minutes</span>
                        </div>
                    ...
                    <div class="card chart-card">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                            ...
                            <span style="font-size: 0.85rem; color: var(--text-muted);">by time</span>
                        </div>
                ...
                <div class="card">
                    <h4 style="margin-bottom: 1rem;">Study Heatmap (Last 30 Days)</h4>
                ...
                <div class="card" style="margin-top: 2rem;">
                    <h4>💡 AI Insights</h4>
                    <ul style="margin-top: 1rem; padding-left: 1.5rem; display: flex; flex-direction: column; gap: 0.5rem;">
                ...
                <div class="grid-2" style="margin-top: 1.5rem; gap: 1.5rem;">
                    <div class="card">
                        <h4 style="margin-bottom: 1rem;">Top Subjects</h4>
                        ${topSubjects.length ? `<ul style="padding-left:1.2rem;">${topSubjects.map(s => `<li><strong>${s.name}</strong> — ${Math.round(s.duration/60)} mins</li>`).join('')}</ul>` : '<p class="text-muted">No subject study data yet.</p>'}
                        <div style="margin-top:1rem; color: var(--text-muted);">Flashcards due: <strong>${flashcardsDue}</strong></div>
                    </div>

                <div class="card">
                    <h4 style="margin-bottom: 1rem;">Recent Sessions</h4>
                    ${recentSessions.length ? `<div style="display:flex; flex-direction:column; gap:0.5rem;">${recentSessions.map(s => `<div style="display:flex; justify-content:space-between; align-items:center;"><div><strong>${s.subjectId ? (subjects.find(x=>x.id===s.subjectId)?.name || 'Unknown') : 'General'}</strong><div class="text-muted" style="font-size:0.85rem;">${new Date(s.timestamp).toLocaleString()}</div></div><div style="font-weight:700; color:var(--text-muted);">${Math.round(s.duration || 0)}m</div></div>`).join('')}</div>` : '<p class="text-muted">No recent study sessions.</p>'}
                </div>
            </div>
            ...
            <div class="card" style="margin-top: 2rem;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                    ...
                    <span style="font-size: 0.85rem; color: var(--text-muted);">total minutes</span>
                </div>
